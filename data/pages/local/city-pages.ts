...
export const ahmedabad: ServicePageData = {
  ...
  hero: {
    ...
    formVariant: "service",
    formTag: "Ahmedabad Project",
    formHeading: "Tell us about your Ahmedabad project",
    formSub: "Free consultation. Response within 24 hours.",
    formSubmitLabel: "Send enquiry",
  },
  services: {
    eyebrow: "What we build",
    heading: "Full-stack digital solutions for Ahmedabad businesses",
    items: [
      {
  ...
  why: {
    ...
    heading: "Serving Ahmedabad businesses since 2013",
    items: [
      {
      ...
      },
      {
        ...
        desc: "Every project is built by engineers with 5+ years of experience. The person you speak with is the person who builds your product.",
      },
      {
        title: "Fixed-price projects, no surprises",
        desc: "We scope carefully and commit in writing. No scope-creep charges, no surprise invoices. The price we quote is the price you pay.",
      },
    ],
  },
  faq: {
    eyebrow: "FAQs",
    heading: "Questions from Ahmedabad clients",
    items: [
      {
  ...
  related: [
    { label: "Web Development", href: "/web-development/", desc: "Full-stack web development services for Ahmedabad businesses." },
    { label: "Website Development", href: "/website-development/", desc: "Professional business websites built fast and affordably." },
    { label: "Custom Software Development", href: "/custom-software-development/", desc: "Bespoke software tailored to your unique business processes." },
    { label: "Web Design Vadodara", href: "/web-design-vadodara/", desc: "Creative web design from Gujarat's leading digital agency." },
  ],
  cta: {
    eyebrow: "Start your project",
    heading: "Let's build something great for your Ahmedabad business",
    body: "Free technical consultation. Fixed price quote within 48 hours. No commitment.",
    primaryCta: { label: "Book a free call", href: "/contact/" },
    secondaryCta: { label: "See our work", href: "/portfolio/" },
    meta: ["Free consultation", "24-hour response", "Senior engineers"],
  },
};
...
export const surat: ServicePageData = {
  ...
  hero: {
    ...
    formVariant: "service",
    formTag: "Surat Project",
    formHeading: "Tell us about your Surat project",
    formSub: "Free consultation. Response within 24 hours.",
    formSubmitLabel: "Send enquiry",
  },
  services: {
    eyebrow: "What we build",
    heading: "Digital solutions built for Surat's trading and manufacturing ecosystem",
    items: [
      {
  ...
  why: {
    eyebrow: "Why Digital Web Weaver",
    heading: "The right engineering partner for Surat's fast-moving businesses",
    items: [
      {
      ...
      },
      {
        ...
        desc: "No juniors, no handoffs. Your project is built by engineers with 5+ years of experience. The same person who scopes your project builds it.",
      },
    ],
  },
  faq: {
    eyebrow: "FAQs",
    heading: "Questions from Surat clients",
    items: [
      {
      ...
      {
        q: "Do you have an office in Surat?",
        a: "Our studio is in Vadodara. We serve Surat clients primarily remotely, with video calls and screen-sharing for day-to-day work. For larger projects, we visit Surat for kickoff meetings and key milestones.",
      },
      {
  ...
  related: [
    { label: "Web Development", href: "/web-development/", desc: "Full-stack web development services for Surat businesses." },
    { label: "Website Development", href: "/website-development/", desc: "Professional business websites built fast and affordably." },
    { label: "E-commerce Development", href: "/ecommerce-development/", desc: "Online stores and B2B portals built for Gujarat's textile and diamond trade." },
    { label: "Web Design Vadodara", href: "/web-design-vadodara/", desc: "Creative web design from Gujarat's leading digital agency." },
  ],
  cta: {
    eyebrow: "Start your project",
    heading: "Ready to build your Surat business online?",
    body: "Free technical consultation. Fixed quote within 48 hours. No commitment required.",
    primaryCta: { label: "Book a free call", href: "/contact/" },
    secondaryCta: { label: "View portfolio", href: "/portfolio/" },
    meta: ["Free consultation", "Gujarati-speaking team", "Fixed pricing"],
  },
};
...
export const rajkot: ServicePageData = {
  ...
  hero: {
    ...
    formVariant: "service",
    formTag: "Rajkot Project",
    formHeading: "Tell us about your Rajkot project",
    formSub: "Free consultation. Response within 24 hours.",
    formSubmitLabel: "Send enquiry",
  },
  services: {
    eyebrow: "What we build",
    heading: "Software solutions built for Rajkot's industrial and MSME ecosystem",
    items: [
      {
      ...
      {
        title: "Export & Quotation Management",
        desc: "Software for Rajkot exporters to manage international buyers, generate quotations in multiple currencies, track shipments, and manage LC documentation.",
        tags: ["Custom", "PDF", "Multi-currency"],
      },
    ],
    variant: "card",
  },
  why: {
    eyebrow: "Why Digital Web Weaver",
    heading: "Built for Rajkot's industrial reality",
    items: [
      {
      ...
      {
        title: "Gujarati-speaking team",
        desc: "Our team speaks Gujarati, Hindi, and English. Explain your business process in your own language. We'll translate it into software that works.",
      },
      {
  ...
  faq: {
    eyebrow: "FAQs",
    heading: "Questions from Rajkot clients",
    items: [
      {
  ...
  related: [
    { label: "Web Development", href: "/web-development/", desc: "Full-stack web development services for Rajkot businesses." },
    { label: "Custom Software Development", href: "/custom-software-development/", desc: "Bespoke software replacing manual processes and spreadsheets." },
    { label: "CRM & ERP Systems", href: "/crm-erp-systems/", desc: "Custom ERP and CRM for Rajkot's manufacturing and trading sectors." },
    { label: "Web Design Vadodara", href: "/web-design-vadodara/", desc: "Creative web design from Gujarat's leading digital agency." },
  ],
  cta: {
    eyebrow: "Start your project",
    heading: "Ready to digitise your Rajkot business?",
    body: "Free technical consultation. Fixed price quote within 48 hours. No commitment.",
    primaryCta: { label: "Book a free call", href: "/contact/" },
    secondaryCta: { label: "View our work", href: "/portfolio/" },
    meta: ["Free consultation", "Gujarati-speaking team", "Senior engineers only"],
  },
};
...
export const gujarat: ServicePageData = {
  ...
  hero: {
    ...
    stats: [
      { value: "200+", label: "Projects Delivered" },
      { value: "Gujarat", label: "Based & Rooted" },
      { value: "8yr", label: "In Business" },
    ],
    formVariant: "service",
    formTag: "Gujarat Project",
    formHeading: "Tell us about your Gujarat project",
    formSub: "Free consultation. Response within 24 hours.",
    formSubmitLabel: "Send enquiry",
  },
  services: {
    eyebrow: "What we build",
    heading: "Full-spectrum digital solutions across Gujarat",
    items: [
      {
  ...
  why: {
    eyebrow: "Why Digital Web Weaver",
    heading: "A Gujarat-based engineering team that gets Gujarat businesses",
    items: [
      {
      ...
      },
      {
        ...
        desc: "100% of our work is done by our in-house senior engineering team. We don't sub-contract. The engineers you meet are the engineers who build your product.",
      },
      {
        title: "Serving Gujarat since 2013",
        desc: "Over eight years, we've built software for manufacturers, traders, healthcare providers, retailers, and startups across Gujarat. That institutional knowledge makes us faster and more accurate on every project.",
      },
    ],
  },
  faq: {
    eyebrow: "FAQs",
    heading: "Questions from Gujarat businesses",
    items: [
      {
      ...
      },
      {
        ...
        a: "Our Gujarat client base spans: manufacturing and engineering goods (Rajkot, Vadodara), textiles and diamonds (Surat), pharmaceutical and chemicals (Vadodara, Ankleshwar), IT and fintech (Ahmedabad, GIFT City), agriculture and food processing (Anand, Junagadh), retail and trading (state-wide), and healthcare. If you're a Gujarat business, we've likely worked with a similar company.",
      },
      {
        q: "Can you build software that integrates with Tally, Zoho, or other tools we already use?",
        a: "Yes. We integrate with Tally ERP, Zoho CRM/Books, IndiaMART, Flipkart Seller, Amazon Seller, Shiprocket, and most other tools that provide an API. If you're on a legacy system, we can often extract and sync data without disrupting your existing workflow.",
      },
      {
      ...
      },
      {
        ...
        a: "Yes. We offer monthly maintenance plans covering bug fixes, security updates, performance monitoring, and minor content changes. For more active products, we offer ongoing development retainers where you get dedicated engineering hours each month. We don't disappear after launch.",
      },
    ],
  },
  related: [
    { label: "Web Development", href: "/web-development/", desc: "Full-stack web development services for Gujarat businesses." },
    { label: "Website Development", href: "/website-development/", desc: "Professional business websites built fast and affordably." },
    { label: "Custom Software Development", href: "/custom-software-development/", desc: "Bespoke software tailored to your unique business processes." },
    { label: "Web Design Vadodara", href: "/web-design-vadodara/", desc: "Creative web design from Gujarat's leading digital agency." },
  ],
  cta: {
    eyebrow: "Start your project",
    heading: "Let's build something great for your Gujarat business",
    body: "Free technical consultation. Fixed price quote within 48 hours. Senior engineers on every project.",
    primaryCta: { label: "Book a free call", href: "/contact/" },
