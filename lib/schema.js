...
export function productsSchema() {
  return {
    ...
    description:
      "17 production-ready software products — LMS, ERP, clinic software, delivery apps, and AI voice agents. White-label ready, deployed with your branding in 2–4 weeks.",
    isPartOf: { "@id": `${BASE}/#website` },
    mainEntity: {
      "@type": "ItemList",
