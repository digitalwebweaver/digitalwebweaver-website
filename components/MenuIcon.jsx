// Small line-icon set for mega menu items — same stroke style already used
// by .cap cards across the site (stroke="currentColor" strokeWidth="1.6").
const PATHS = {
...
export default function MenuIcon({ name, size = 18 }) {
