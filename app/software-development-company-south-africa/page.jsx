...
export default function Page() {
  return (
    <>
    <JsonLd data={serviceSchema({ name: "Software Development Company South Africa", description: "Offshore software development partner for South African businesses — bespoke web apps, e-commerce platforms, custom software, and dedicated teams from senior engineers with near-real-time IST/SAST overlap.", href: "/software-development-company-south-africa/" })} />
