...
export default function Page() {
  return (
    <>
    <JsonLd data={[localBusinessSchema({ city: "surat", description: "Web development company serving Surat — B2B wholesale portals, e-commerce platforms, and custom ERP for diamond, textile, and manufacturing businesses." }), serviceSchema({ name: "Web Design & Development Surat", description: "Senior engineers building custom digital solutions for Surat's trading community — B2B wholesale portals, e-commerce, and custom ERP for SME manufacturers.", href: "/web-design-surat/" })]} />
