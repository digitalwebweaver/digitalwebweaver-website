...
export default function Page() {
  return (
    <>
    <JsonLd data={softwareApplicationSchema({ name: "QuickBite", description: "QuickBite gives restaurants and cloud kitchens a complete delivery ecosystem — customer app, restaurant dashboard, and delivery partner app — 0% commission, live in 6–8 weeks.", href: "/quickbite/" })} />
          ...
          <div className="formcard" id="demo">
            ...
            <form className="formcard__pad" data-form>
              ...
              <div className="field-row">
                ...
                <div className="field"><label className="label">WORK EMAIL *</label><input className="input" name="email" type="email" placeholder="you@restaurant.com" required /></div>
              </div>
              <div className="field-row">
