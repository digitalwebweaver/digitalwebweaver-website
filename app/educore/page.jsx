...
export default function Page() {
  return (
    <>
    <JsonLd data={softwareApplicationSchema({ name: "EduCore", description: "EduCore bundles course delivery, live classes, assessments, certificates, and fee collection into one branded LMS. White-labelled, live in 4–6 weeks, 0% revenue cut.", href: "/educore/" })} />
          ...
          <div className="formcard" id="demo">
            ...
            <form className="formcard__pad" data-form>
              ...
              <div className="field-row">
                ...
                <div className="field"><label className="label">WORK EMAIL</label><input className="input" name="email" type="email" placeholder="you@institute.com" /></div>
              </div>
              <div className="field-row">
