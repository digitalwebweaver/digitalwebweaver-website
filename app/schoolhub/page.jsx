...
export default function Page() {
  return (
    <>
    <JsonLd data={softwareApplicationSchema({ name: "SchoolHub", description: "SchoolHub consolidates admissions, attendance, timetables, fee collection, exams, report cards, and parent communication into one branded platform. Live in 5–7 weeks.", href: "/schoolhub/" })} />
          ...
          <div className="formcard" id="demo">
            ...
            <form className="formcard__pad" data-form>
              ...
              <div className="field-row">
                ...
                <div className="field"><label className="label">WORK EMAIL</label><input className="input" name="email" type="email" placeholder="you@school.edu" /></div>
              </div>
              <div className="field-row">
