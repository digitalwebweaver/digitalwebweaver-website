...
export default function Page() {
  return (
    <>
    <JsonLd data={softwareApplicationSchema({ name: "ChatFlow AI", description: "ChatFlow AI answers enquiries, books appointments, sends order updates, and follows up with customers automatically — on your business WhatsApp number, in your brand's voice, around the clock.", href: "/chatflow-ai/" })} />
