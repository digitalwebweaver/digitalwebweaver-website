      ...
      <div className="content scroll">
        ...
        <section id="s-stack" className="section reveal">
          ...
          <div className="stack-grid">
            <div className="stack-cell" data-cat="Frontend"><span className="stack-cell__logo"><img src="/assets/icons/react.svg" alt="React" /><span className="stack-cell__mono" style={{color:"#61dafb"}}>R</span></span><div><div className="stack-cell__name">React</div><div className="stack-cell__cat">Frontend</div></div></div>
            <div className="stack-cell" data-cat="Frontend"><span className="stack-cell__logo"><img src="/assets/icons/nextdotjs.svg" alt="Next.js" /><span className="stack-cell__mono" style={{color:"#e6edf3"}}>N</span></span><div><div className="stack-cell__name">Next.js</div><div className="stack-cell__cat">Frontend</div></div></div>
            <div className="stack-cell" data-cat="Frontend"><span className="stack-cell__logo"><img src="/assets/icons/vuedotjs.svg" alt="Vue.js" /><span className="stack-cell__mono" style={{color:"#42b883"}}>V</span></span><div><div className="stack-cell__name">Vue.js</div><div className="stack-cell__cat">Frontend</div></div></div>
            <div className="stack-cell" data-cat="Frontend"><span className="stack-cell__logo"><img src="/assets/icons/typescript.svg" alt="TypeScript" /><span className="stack-cell__mono" style={{color:"#3178c6"}}>TS</span></span><div><div className="stack-cell__name">TypeScript</div><div className="stack-cell__cat">Frontend</div></div></div>
            <div className="stack-cell" data-cat="Frontend"><span className="stack-cell__logo"><img src="/assets/icons/tailwindcss.svg" alt="Tailwind" /><span className="stack-cell__mono" style={{color:"#56d4c4"}}>Tw</span></span><div><div className="stack-cell__name">Tailwind</div><div className="stack-cell__cat">Frontend</div></div></div>
            <div className="stack-cell" data-cat="Backend"><span className="stack-cell__logo"><img src="/assets/icons/nodedotjs.svg" alt="Node.js" /><span className="stack-cell__mono" style={{color:"#9ad17f"}}>No</span></span><div><div className="stack-cell__name">Node.js</div><div className="stack-cell__cat">Backend</div></div></div>
            <div className="stack-cell" data-cat="Backend"><span className="stack-cell__logo"><img src="/assets/icons/laravel.svg" alt="Laravel / PHP" /><span className="stack-cell__mono" style={{color:"#ff5c8a"}}>L</span></span><div><div className="stack-cell__name">Laravel / PHP</div><div className="stack-cell__cat">Backend</div></div></div>
            <div className="stack-cell" data-cat="Backend"><span className="stack-cell__logo"><img src="/assets/icons/python.svg" alt="Python" /><span className="stack-cell__mono" style={{color:"#e3b341"}}>Py</span></span><div><div className="stack-cell__name">Python</div><div className="stack-cell__cat">Backend</div></div></div>
            <div className="stack-cell" data-cat="Backend"><span className="stack-cell__logo"><img src="/assets/icons/django.svg" alt="Django" /><span className="stack-cell__mono" style={{color:"#56d4c4"}}>Dj</span></span><div><div className="stack-cell__name">Django</div><div className="stack-cell__cat">Backend</div></div></div>
            <div className="stack-cell" data-cat="Backend"><span className="stack-cell__logo"><img src="/assets/icons/express.svg" alt="Express" /><span className="stack-cell__mono" style={{color:"#e6edf3"}}>Ex</span></span><div><div className="stack-cell__name">Express</div><div className="stack-cell__cat">Backend</div></div></div>
            <div className="stack-cell" data-cat="Database"><span className="stack-cell__logo"><img src="/assets/icons/postgresql.svg" alt="PostgreSQL" /><span className="stack-cell__mono" style={{color:"#56d4c4"}}>Pg</span></span><div><div className="stack-cell__name">PostgreSQL</div><div className="stack-cell__cat">Database</div></div></div>
            <div className="stack-cell" data-cat="Database"><span className="stack-cell__logo"><img src="/assets/icons/mysql.svg" alt="MySQL" /><span className="stack-cell__mono" style={{color:"#e3b341"}}>My</span></span><div><div className="stack-cell__name">MySQL</div><div className="stack-cell__cat">Database</div></div></div>
            <div className="stack-cell" data-cat="Database"><span className="stack-cell__logo"><img src="/assets/icons/mongodb.svg" alt="MongoDB" /><span className="stack-cell__mono" style={{color:"#9ad17f"}}>M</span></span><div><div className="stack-cell__name">MongoDB</div><div className="stack-cell__cat">Database</div></div></div>
            <div className="stack-cell" data-cat="Database"><span className="stack-cell__logo"><img src="/assets/icons/redis.svg" alt="Redis" /><span className="stack-cell__mono" style={{color:"#ff5c8a"}}>Rd</span></span><div><div className="stack-cell__name">Redis</div><div className="stack-cell__cat">Database</div></div></div>
            <div className="stack-cell" data-cat="Mobile"><span className="stack-cell__logo"><img src="/assets/icons/react.svg" alt="React Native" /><span className="stack-cell__mono" style={{color:"#61dafb"}}>RN</span></span><div><div className="stack-cell__name">React Native</div><div className="stack-cell__cat">Mobile</div></div></div>
            <div className="stack-cell" data-cat="Mobile"><span className="stack-cell__logo"><img src="/assets/icons/flutter.svg" alt="Flutter" /><span className="stack-cell__mono" style={{color:"#56d4c4"}}>Fl</span></span><div><div className="stack-cell__name">Flutter</div><div className="stack-cell__cat">Mobile</div></div></div>
            <div className="stack-cell" data-cat="Mobile"><span className="stack-cell__logo"><img src="/assets/icons/swift.svg" alt="Swift" /><span className="stack-cell__mono" style={{color:"#ff5c8a"}}>Sw</span></span><div><div className="stack-cell__name">Swift</div><div className="stack-cell__cat">Mobile</div></div></div>
            <div className="stack-cell" data-cat="Mobile"><span className="stack-cell__logo"><img src="/assets/icons/kotlin.svg" alt="Kotlin" /><span className="stack-cell__mono" style={{color:"#e3b341"}}>Kt</span></span><div><div className="stack-cell__name">Kotlin</div><div className="stack-cell__cat">Mobile</div></div></div>
            ...
            <div className="stack-cell" data-cat="Cloud/DevOps"><span className="stack-cell__logo"><img src="/assets/icons/docker.svg" alt="Docker" /><span className="stack-cell__mono" style={{color:"#61dafb"}}>Dk</span></span><div><div className="stack-cell__name">Docker</div><div className="stack-cell__cat">Cloud/DevOps</div></div></div>
            <div className="stack-cell" data-cat="Cloud/DevOps"><span className="stack-cell__logo"><img src="/assets/icons/kubernetes.svg" alt="Kubernetes" /><span className="stack-cell__mono" style={{color:"#56d4c4"}}>K8</span></span><div><div className="stack-cell__name">Kubernetes</div><div className="stack-cell__cat">Cloud/DevOps</div></div></div>
            <div className="stack-cell" data-cat="Cloud/DevOps"><span className="stack-cell__logo"><img src="/assets/icons/terraform.svg" alt="Terraform" /><span className="stack-cell__mono" style={{color:"#c99bb4"}}>Tf</span></span><div><div className="stack-cell__name">Terraform</div><div className="stack-cell__cat">Cloud/DevOps</div></div></div>
            ...
            <div className="stack-cell" data-cat="AI"><span className="stack-cell__logo"><img src="/assets/icons/langchain.svg" alt="LangChain" /><span className="stack-cell__mono" style={{color:"#56d4c4"}}>LC</span></span><div><div className="stack-cell__name">LangChain</div><div className="stack-cell__cat">AI</div></div></div>
            <div className="stack-cell" data-cat="AI"><span className="stack-cell__logo"><img src="/assets/icons/anthropic.svg" alt="Anthropic" /><span className="stack-cell__mono" style={{color:"#e6edf3"}}>An</span></span><div><div className="stack-cell__name">Anthropic</div><div className="stack-cell__cat">AI</div></div></div>
            <div className="stack-cell" data-cat="AI"><span className="stack-cell__logo"><img src="/assets/icons/qdrant.svg" alt="RAG / Vector" /><span className="stack-cell__mono" style={{color:"#e3b341"}}>Ve</span></span><div><div className="stack-cell__name">RAG / Vector</div><div className="stack-cell__cat">AI</div></div></div>
          </div>
        </section>
