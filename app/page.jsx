    ...
    <main className="main">
      ...
      <div className="content scroll">
        ...
        <section id="s-work" className="section reveal">
          ...
          <div className="grid grid-3 stagger">
            <Link className="work" href="/solarflow/"><div className="work__bar"><span className="d dot--red"></span><span className="d dot--amber"></span><span className="d dot--green"></span><span className="work__host">app.solarflow.io</span></div><div className="work__shot"><img src="/assets/solarflow-project.webp" alt="SolarFlow ERP + CRM" width="380" height="188" loading="lazy" decoding="async" /></div><div className="work__pad"><div className="work__tag">SAAS · SOLAR</div><div className="work__title">SolarFlow ERP + CRM</div><div className="work__metric"><b>Surya Ghar</b><span>subsidy lifecycle</span></div><div className="work__stack"><span className="tag tag--y">React</span><span className="tag tag--y">Node</span><span className="tag tag--y">Postgres</span></div><div className="work__view">View case ↗</div></div></Link>
            <Link className="work" href="/portfolio/"><div className="work__bar"><span className="d dot--red"></span><span className="d dot--amber"></span><span className="d dot--green"></span><span className="work__host">erp.panelos.app</span></div><div className="work__shot"><img src="/assets/pufpanel-dashboard.webp" alt="PanelOS" width="380" height="188" loading="lazy" decoding="async" /></div><div className="work__pad"><div className="work__tag">ERP · MANUFACTURING</div><div className="work__title">PanelOS</div><div className="work__metric"><b>order → cash</b><span>one pipeline</span></div><div className="work__stack"><span className="tag tag--y">Laravel</span><span className="tag tag--y">MySQL</span><span className="tag tag--y">Docker</span></div><div className="work__view">View case ↗</div></div></Link>
            <Link className="work" href="/manchify/"><div className="work__bar"><span className="d dot--red"></span><span className="d dot--amber"></span><span className="d dot--green"></span><span className="work__host">app.manchify.com</span></div><div className="work__shot"><img src="/assets/eventos-quote.webp" alt="Manchify / EventOS" width="380" height="188" loading="lazy" decoding="async" /></div><div className="work__pad"><div className="work__tag">CRM · EVENTS</div><div className="work__title">Manchify / EventOS</div><div className="work__metric"><b>lead → settle</b><span>full funnel</span></div><div className="work__stack"><span className="tag tag--y">Vue</span><span className="tag tag--y">Node</span><span className="tag tag--y">MongoDB</span></div><div className="work__view">View case ↗</div></div></Link>
          </div>

          <div className="work-carousel" data-carousel>
            <button className="work-carousel__nav prev" data-carousel-prev aria-label="Previous projects">‹</button>
            <div className="work-carousel__track" data-carousel-track>
              <Link className="work-mini" href="/portfolio/"><div className="work__pad"><div className="work__tag">QA · TRANSFORMERS</div><div className="work__title">Test Bay OS</div><div className="work__metrics"><div className="work__mcell"><b>live</b><span>temp-rise testing</span></div><div className="work__mcell"><b>3</b><span>core technologies</span></div></div><div className="work__stack"><span className="tag tag--y">React</span><span className="tag tag--y">Python</span><span className="tag tag--y">WebSockets</span></div><div className="work__view">View case ↗</div></div></Link>
              <Link className="work-mini" href="/portfolio/"><div className="work__pad"><div className="work__tag">MANUFACTURING · INDIA</div><div className="work__title">ManufacturIQ — Smart ERP</div><div className="work__metrics"><div className="work__mcell"><b>40%</b><span>cost reduction</span></div><div className="work__mcell"><b>3×</b><span>faster reports</span></div></div><div className="work__stack"><span className="tag tag--y">Laravel</span><span className="tag tag--y">Vue.js</span><span className="tag tag--y">MySQL</span></div><div className="work__view">View case ↗</div></div></Link>
              <Link className="work-mini" href="/portfolio/"><div className="work__pad"><div className="work__tag">EDTECH · AUSTRALIA</div><div className="work__title">Next Sense LMS Web</div><div className="work__metrics"><div className="work__mcell"><b>40%</b><span>dispatch time cut</span></div><div className="work__mcell"><b>3</b><span>core technologies</span></div></div><div className="work__stack"><span className="tag tag--y">React Native</span><span className="tag tag--y">Node.js</span><span className="tag tag--y">MongoDB</span></div><div className="work__view">View case ↗</div></div></Link>
              <Link className="work-mini" href="/portfolio/"><div className="work__pad"><div className="work__tag">SAAS · UK</div><div className="work__title">Learning Management System</div><div className="work__metrics"><div className="work__mcell"><b>50k</b><span>students</span></div><div className="work__mcell"><b>3</b><span>regions</span></div></div><div className="work__stack"><span className="tag tag--y">Next.js</span><span className="tag tag--y">PostgreSQL</span><span className="tag tag--y">AWS</span></div><div className="work__view">View case ↗</div></div></Link>
              <Link className="work-mini" href="/portfolio/"><div className="work__pad"><div className="work__tag">LOGISTICS · INDIA</div><div className="work__title">Trip Operator</div><div className="work__metrics"><div className="work__mcell"><b>98%</b><span>uptime</span></div><div className="work__mcell"><b>4</b><span>core technologies</span></div></div><div className="work__stack"><span className="tag tag--y">React</span><span className="tag tag--y">Python</span><span className="tag tag--y">AWS</span></div><div className="work__view">View case ↗</div></div></Link>
              <Link className="work-mini" href="/portfolio/"><div className="work__pad"><div className="work__tag">CRM · UAE</div><div className="work__title">PropNest — Real Estate CRM</div><div className="work__metrics"><div className="work__mcell"><b>500+</b><span>agents</span></div><div className="work__mcell"><b>60%</b><span>faster closure</span></div></div><div className="work__stack"><span className="tag tag--y">React</span><span className="tag tag--y">Node.js</span><span className="tag tag--y">PostgreSQL</span></div><div className="work__view">View case ↗</div></div></Link>
              <Link className="work-mini" href="/portfolio/"><div className="work__pad"><div className="work__tag">AI · AUTOMATION · AUSTRALIA</div><div className="work__title">Document AI Pipeline</div><div className="work__metrics"><div className="work__mcell"><b>97%</b><span>accuracy</span></div><div className="work__mcell"><b>10k</b><span>docs / day</span></div></div><div className="work__stack"><span className="tag tag--y">Python</span><span className="tag tag--y">OpenAI</span><span className="tag tag--y">FastAPI</span></div><div className="work__view">View case ↗</div></div></Link>
              <Link className="work-mini" href="/portfolio/"><div className="work__pad"><div className="work__tag">E-COMMERCE · UK</div><div className="work__title">Headless Commerce Platform</div><div className="work__metrics"><div className="work__mcell"><b>2.8×</b><span>conversion rate</span></div><div className="work__mcell"><b>99%</b><span>uptime</span></div></div><div className="work__stack"><span className="tag tag--y">Next.js</span><span className="tag tag--y">Shopify API</span><span className="tag tag--y">Node.js</span></div><div className="work__view">View case ↗</div></div></Link>
              <Link className="work-mini" href="/portfolio/"><div className="work__pad"><div className="work__tag">HEALTHCARE · US</div><div className="work__title">Telemedicine Platform</div><div className="work__metrics"><div className="work__mcell"><b>8k</b><span>consults / month</span></div><div className="work__mcell"><b>HIPAA</b><span>compliant</span></div></div><div className="work__stack"><span className="tag tag--y">React</span><span className="tag tag--y">Node.js</span><span className="tag tag--y">WebRTC</span></div><div className="work__view">View case ↗</div></div></Link>
              <Link className="work-mini" href="/portfolio/"><div className="work__pad"><div className="work__tag">LOGISTICS · INDIA</div><div className="work__title">LogiCore — Logistics ERP</div><div className="work__metrics"><div className="work__mcell"><b>25%</b><span>fuel savings</span></div><div className="work__mcell"><b>1,200</b><span>daily trips</span></div></div><div className="work__stack"><span className="tag tag--y">Node.js</span><span className="tag tag--y">React</span><span className="tag tag--y">PostgreSQL</span></div><div className="work__view">View case ↗</div></div></Link>
            </div>
            <button className="work-carousel__nav next" data-carousel-next aria-label="More projects">›</button>
          </div>
        </section>
