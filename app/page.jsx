      ...
      <div className="content scroll">
        ...
        <section id="s-stack" className="section reveal">
          ...
          <div className="stack-grid">
            <div className="stack-cell" data-cat="Frontend"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/react/61dafb" alt="React" /><span className="stack-cell__mono" style={{color:"#61dafb"}}>R</span></span><div><div className="stack-cell__name">React</div><div className="stack-cell__cat">Frontend</div></div></div>
            <div className="stack-cell" data-cat="Frontend"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/nextdotjs/e6edf3" alt="Next.js" /><span className="stack-cell__mono" style={{color:"#e6edf3"}}>N</span></span><div><div className="stack-cell__name">Next.js</div><div className="stack-cell__cat">Frontend</div></div></div>
            <div className="stack-cell" data-cat="Frontend"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/vuedotjs/42b883" alt="Vue.js" /><span className="stack-cell__mono" style={{color:"#42b883"}}>V</span></span><div><div className="stack-cell__name">Vue.js</div><div className="stack-cell__cat">Frontend</div></div></div>
            <div className="stack-cell" data-cat="Frontend"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/typescript/3178c6" alt="TypeScript" /><span className="stack-cell__mono" style={{color:"#3178c6"}}>TS</span></span><div><div className="stack-cell__name">TypeScript</div><div className="stack-cell__cat">Frontend</div></div></div>
            <div className="stack-cell" data-cat="Frontend"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/tailwindcss/56d4c4" alt="Tailwind" /><span className="stack-cell__mono" style={{color:"#56d4c4"}}>Tw</span></span><div><div className="stack-cell__name">Tailwind</div><div className="stack-cell__cat">Frontend</div></div></div>
            <div className="stack-cell" data-cat="Backend"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/nodedotjs/9ad17f" alt="Node.js" /><span className="stack-cell__mono" style={{color:"#9ad17f"}}>No</span></span><div><div className="stack-cell__name">Node.js</div><div className="stack-cell__cat">Backend</div></div></div>
            <div className="stack-cell" data-cat="Backend"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/laravel/ff5c8a" alt="Laravel / PHP" /><span className="stack-cell__mono" style={{color:"#ff5c8a"}}>L</span></span><div><div className="stack-cell__name">Laravel / PHP</div><div className="stack-cell__cat">Backend</div></div></div>
            <div className="stack-cell" data-cat="Backend"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/python/e3b341" alt="Python" /><span className="stack-cell__mono" style={{color:"#e3b341"}}>Py</span></span><div><div className="stack-cell__name">Python</div><div className="stack-cell__cat">Backend</div></div></div>
            <div className="stack-cell" data-cat="Backend"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/django/56d4c4" alt="Django" /><span className="stack-cell__mono" style={{color:"#56d4c4"}}>Dj</span></span><div><div className="stack-cell__name">Django</div><div className="stack-cell__cat">Backend</div></div></div>
            <div className="stack-cell" data-cat="Backend"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/express/e6edf3" alt="Express" /><span className="stack-cell__mono" style={{color:"#e6edf3"}}>Ex</span></span><div><div className="stack-cell__name">Express</div><div className="stack-cell__cat">Backend</div></div></div>
            <div className="stack-cell" data-cat="Database"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/postgresql/56d4c4" alt="PostgreSQL" /><span className="stack-cell__mono" style={{color:"#56d4c4"}}>Pg</span></span><div><div className="stack-cell__name">PostgreSQL</div><div className="stack-cell__cat">Database</div></div></div>
            <div className="stack-cell" data-cat="Database"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/mysql/e3b341" alt="MySQL" /><span className="stack-cell__mono" style={{color:"#e3b341"}}>My</span></span><div><div className="stack-cell__name">MySQL</div><div className="stack-cell__cat">Database</div></div></div>
            <div className="stack-cell" data-cat="Database"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/mongodb/9ad17f" alt="MongoDB" /><span className="stack-cell__mono" style={{color:"#9ad17f"}}>M</span></span><div><div className="stack-cell__name">MongoDB</div><div className="stack-cell__cat">Database</div></div></div>
            <div className="stack-cell" data-cat="Database"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/redis/ff5c8a" alt="Redis" /><span className="stack-cell__mono" style={{color:"#ff5c8a"}}>Rd</span></span><div><div className="stack-cell__name">Redis</div><div className="stack-cell__cat">Database</div></div></div>
            <div className="stack-cell" data-cat="Mobile"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/react/61dafb" alt="React Native" /><span className="stack-cell__mono" style={{color:"#61dafb"}}>RN</span></span><div><div className="stack-cell__name">React Native</div><div className="stack-cell__cat">Mobile</div></div></div>
            <div className="stack-cell" data-cat="Mobile"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/flutter/56d4c4" alt="Flutter" /><span className="stack-cell__mono" style={{color:"#56d4c4"}}>Fl</span></span><div><div className="stack-cell__name">Flutter</div><div className="stack-cell__cat">Mobile</div></div></div>
            <div className="stack-cell" data-cat="Mobile"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/swift/ff5c8a" alt="Swift" /><span className="stack-cell__mono" style={{color:"#ff5c8a"}}>Sw</span></span><div><div className="stack-cell__name">Swift</div><div className="stack-cell__cat">Mobile</div></div></div>
            <div className="stack-cell" data-cat="Mobile"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/kotlin/e3b341" alt="Kotlin" /><span className="stack-cell__mono" style={{color:"#e3b341"}}>Kt</span></span><div><div className="stack-cell__name">Kotlin</div><div className="stack-cell__cat">Mobile</div></div></div>
            <div className="stack-cell" data-cat="Cloud/DevOps"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/amazonwebservices/e3b341" alt="AWS" /><span className="stack-cell__mono" style={{color:"#e3b341"}}>aws</span></span><div><div className="stack-cell__name">AWS</div><div className="stack-cell__cat">Cloud/DevOps</div></div></div>
            <div className="stack-cell" data-cat="Cloud/DevOps"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/docker/61dafb" alt="Docker" /><span className="stack-cell__mono" style={{color:"#61dafb"}}>Dk</span></span><div><div className="stack-cell__name">Docker</div><div className="stack-cell__cat">Cloud/DevOps</div></div></div>
            <div className="stack-cell" data-cat="Cloud/DevOps"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/kubernetes/56d4c4" alt="Kubernetes" /><span className="stack-cell__mono" style={{color:"#56d4c4"}}>K8</span></span><div><div className="stack-cell__name">Kubernetes</div><div className="stack-cell__cat">Cloud/DevOps</div></div></div>
            <div className="stack-cell" data-cat="Cloud/DevOps"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/terraform/c99bb4" alt="Terraform" /><span className="stack-cell__mono" style={{color:"#c99bb4"}}>Tf</span></span><div><div className="stack-cell__name">Terraform</div><div className="stack-cell__cat">Cloud/DevOps</div></div></div>
            <div className="stack-cell" data-cat="AI"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/openai/9ad17f" alt="OpenAI" /><span className="stack-cell__mono" style={{color:"#9ad17f"}}>AI</span></span><div><div className="stack-cell__name">OpenAI</div><div className="stack-cell__cat">AI</div></div></div>
            <div className="stack-cell" data-cat="AI"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/langchain/56d4c4" alt="LangChain" /><span className="stack-cell__mono" style={{color:"#56d4c4"}}>LC</span></span><div><div className="stack-cell__name">LangChain</div><div className="stack-cell__cat">AI</div></div></div>
            <div className="stack-cell" data-cat="AI"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/anthropic/e6edf3" alt="Anthropic" /><span className="stack-cell__mono" style={{color:"#e6edf3"}}>An</span></span><div><div className="stack-cell__name">Anthropic</div><div className="stack-cell__cat">AI</div></div></div>
            <div className="stack-cell" data-cat="AI"><span className="stack-cell__logo"><img src="https://cdn.simpleicons.org/qdrant/e3b341" alt="RAG / Vector" /><span className="stack-cell__mono" style={{color:"#e3b341"}}>Ve</span></span><div><div className="stack-cell__name">RAG / Vector</div><div className="stack-cell__cat">AI</div></div></div>
          </div>
        </section>
        ...
        <section id="s-studio" className="section section--split reveal">
          ...
          <figure className="studio-img">
            <img src="/assets/studio-panorama.jpg" alt="Digital Web Weaver studio" width="720" height="480" loading="lazy" decoding="async" />
            ...
            <div className="reviews-grid">
              <div className="review-cell" style={{padding:"22px",display:"flex",flexDirection:"column",background:"var(--panel)",borderRight:"1px solid var(--border)"}}>
                <div style={{display:"flex",alignItems:"center",gap:"11px"}}>
                  ...
                  <span className="mono" style={{marginLeft:"auto",display:"flex",alignItems:"center",gap:"5px",fontSize:"11px",fontWeight:700,color:"var(--green)",background:"rgba(154,209,127,0.1)",border:"1px solid rgba(154,209,127,0.25)",borderRadius:"20px",padding:"3px 9px",whiteSpace:"nowrap",flexShrink:0}}>✓ approved</span>
                </div>
