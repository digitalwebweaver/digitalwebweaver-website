...
export default function Page() {
  return (
    <>
    <JsonLd data={softwareApplicationSchema({ name: "CallMate AI", description: "CallMate AI answers inbound calls, qualifies leads, books appointments, and makes follow-up and reminder calls automatically — in your brand's tone, around the clock.", href: "/callmate-ai/" })} />
