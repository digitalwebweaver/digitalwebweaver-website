...
export default function Page() {
  return (
    <>
    <JsonLd data={serviceSchema({ name: "Custom Software", description: "Bespoke ERP, CRM, internal tools, and client portals built around your exact workflow — not a packaged product you bend your team around. Fixed price. 200+ systems built.", href: "/custom-software-development/" })} />
