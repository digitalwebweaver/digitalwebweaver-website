...
export default function Page() {
  return (
    <>
    <JsonLd data={softwareApplicationSchema({ name: "VetCare", description: "VetCare: appointments, patient records, stock, billing, and client WhatsApp in one affordable system — WhatsApp-first, SARS-ready, loadshedding-proof for South African vets.", href: "/vetcare/" })} />
          ...
          <div className="formcard" id="demo">
            ...
            <form className="formcard__pad" data-form>
              ...
              <div className="field-row">
                ...
                <div className="field"><label className="label">WORK EMAIL *</label><input className="input" name="email" type="email" placeholder="you@practice.co.za" required /></div>
              </div>
              <div className="field-row">
