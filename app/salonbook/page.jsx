...
export default function Page() {
  return (
    <>
    <JsonLd data={softwareApplicationSchema({ name: "SalonBook", description: "SalonBook brings online booking, staff scheduling, billing, service packages, inventory, and automated client follow-ups into one branded system. Live in 3–5 weeks.", href: "/salonbook/" })} />
          ...
          <div className="formcard" id="demo">
            ...
            <form className="formcard__pad" data-form>
              ...
              <div className="field-row">
                ...
                <div className="field"><label className="label">WORK EMAIL</label><input className="input" name="email" type="email" placeholder="you@salon.com" /></div>
              </div>
              <div className="field-row">
