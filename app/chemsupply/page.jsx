...
export default function Page() {
  return (
    <>
    <JsonLd data={softwareApplicationSchema({ name: "ChemSupply", description: "ChemSupply brings batch & expiry tracking, compliance documentation, order management, distributor portals, and multi-warehouse inventory into one connected ERP for chemical suppliers.", href: "/chemsupply/" })} />
