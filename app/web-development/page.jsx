...
export default function Page() {
  return (
    <>
    <JsonLd data={serviceSchema({ name: "Web Development", description: "Full-spectrum web development: marketing sites, web portals, web apps, and API backends. React, Next.js, Node.js, and TypeScript. India-based senior team.", href: "/web-development/" })} />
