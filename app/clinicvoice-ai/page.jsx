...
export default function Page() {
  return (
    <>
    <JsonLd data={softwareApplicationSchema({ name: "ClinicVoice AI", description: "ClinicVoice AI answers calls, books appointments, sends reminders, answers common questions, and follows up after visits — automatically, in a natural voice, around the clock.", href: "/clinicvoice-ai/" })} />
